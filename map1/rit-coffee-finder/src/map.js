...
function initMap() {
    mapboxgl.accessToken = 'pk.eyJ1IjoicmVndWxhcnN0aXYiLCJhIjoiY2t6bmZudGp1MDc4bDJ4cTR1c2VheGQzcyJ9.gHO5QIFJx68O5LV34s1DHQ';
...
function loadMarkers() {
    ...
    for (const shops of coffeeShops) {
        const newFeature = {
            type: 'Feature',
            geometry: {
                type: 'Point',
        ...
        newFeature.geometry.coordinates[0] = shops.longitude;
        newFeature.geometry.coordinates[1] = shops.latitude;
        newFeature.properties.title = shops.title;
